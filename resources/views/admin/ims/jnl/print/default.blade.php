<?php
    ...
    foreach ($CompanyDetailTypes as $CompanyDetailType){
        ...
        if($CompanyDetailType->code === config('companyDetailType.name')){
            $companyName = $CompanyDetailType? !$CompanyDetailType->CompanyDetail->isEmpty()? $CompanyDetailType->CompanyDetail->first()->value :'' :'';
        }else if ($CompanyDetailType->code === config('companyDetailType.contact')){
            $companyContact = $CompanyDetailType? !$CompanyDetailType->CompanyDetail->isEmpty()? $CompanyDetailType->CompanyDetail->first()->value :'' :'';
        }else if ($CompanyDetailType->code === config('companyDetailType.email')){
            $companyEmail = $CompanyDetailType? !$CompanyDetailType->CompanyDetail->isEmpty()? $CompanyDetailType->CompanyDetail->first()->value :'' :'';
        }else if ($CompanyDetailType->code === config('companyDetailType.website')){
            $companyWebsite = $CompanyDetailType? !$CompanyDetailType->CompanyDetail->isEmpty()? $CompanyDetailType->CompanyDetail->first()->value :'' :'';
        }else if ($CompanyDetailType->code === config('companyDetailType.address')){
            $companyAddress = $CompanyDetailType? !$CompanyDetailType->CompanyDetail->isEmpty()? $CompanyDetailType->CompanyDetail->first()->value :'' :'';
        }
    }
...
<div class="container">
    ...
    <div class="invoice-content row px-5 pt-5">
        <div class="col-3">
            <h5 class="almost-gray mb-3">Journal to:</h5>
        ...
        <div class="col-3">
            <h5 class="almost-gray">Journal number:</h5>
    ...
    <div class="row mt-5">
        <div class="col-10 offset-1 invoice-table pt-1">
            <table class="table table-hover">
                ...
                <tbody>
                <?php $countt = 1?>
                @foreach(\App\Models\Ims\JnlItem::where('invoice_id',$Invoice->id)->get() as $item)
                    <tr>
    ...
    <p class="text-center pb-3"><em>{{ $Invoice->remarks }}</em></p>
</div>
