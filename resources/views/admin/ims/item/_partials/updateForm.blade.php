<div class="box-body">
    ...
    <div class="col-md-2 col-sm-3">
        <div class="form-group">
            ...
            {!!
            Form::text('description',$Item->description,['class'=>'form-control','id'=>'description','placeholder'=>'Description'])
            !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!!
            Form::text('opening_stock_qty',0,['class'=>'form-control','id'=>'opening_stock_qty','placeholder'=>'Open
            Stock']) !!}
        </div>
    </div>
