        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!!
                    Form::select('item_code_batch_id',$ItemCodeBatches,$Item->item_code_batch_id,['class'=>'form-control','id'=>'item_code_batch_id'])
                    !!}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::select('color_id',$Colors,$Item->color_id,['class'=>'form-control','id'=>'color_id']) !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="Brand">Size</label>
                    {!! Form::select('size_id',$Sizes,$Item->size_id,['class'=>'form-control','id'=>'size_id']) !!}
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    {!! Form::label("Name") !!}
                    {!! Form::text('name',$Item->name,['class'=>'form-control','id'=>'name','placeholder'=>'Model
                    Name']) !!}
                </div>
            </div>
        ...
        <div class="box-body">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!!
                    Form::text('unit_cost',$Item->unit_cost,['class'=>'form-control','id'=>'unit_cost','placeholder'=>'Unit
                    Cost (LKR)']) !!}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!!
                    Form::text('selling_price',$Item->selling_price,['class'=>'form-control','id'=>'SellingPrice','placeholder'=>'Selling
                    Price (LKR)']) !!}
                </div>
            </div>
            <div class="col-md-6">
