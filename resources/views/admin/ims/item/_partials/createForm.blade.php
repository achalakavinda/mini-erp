<div class="box-body">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('unit_cost',null,['class'=>'form-control','id'=>'unit_cost','placeholder'=>'Unit Cost (LKR)']) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('selling_price',null,['class'=>'form-control','id'=>'SellingPrice','placeholder'=>'Selling Price (LKR)']) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('opening_stock_qty',null,['class'=>'form-control','id'=>'opening_stock_qty','placeholder'=>'Open Stock']) !!}
        </div>
    </div>
