                ...
                <table id="table" class="table table-responsive table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{!! $item->code !!}</td>
                            <td>{!! $item->date !!}</td>
                            <td>{!! $item->supplier ? $item->supplier->name : "No Supplier Found" !!}</td>
                            ...
                            <td>
                                ...
                                <a target="_blank" style="padding: 10px"
                                    href="{!! url('ims/purchase-requisition/'.$item->purchase_requisition_id) !!}"><i
                                        class="fa fa-list"></i> Purchase Requisition</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
