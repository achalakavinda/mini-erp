...
@section('main-content-header')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">New Appointment</h3>
        </div>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    {!! Form::open(['action' => 'AppointmentController@store', 'class' => 'form-horizontal', 'id' => 'Form']) !!}
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            {!! Form::submit('Create Appointment', ['class' => 'btn btn-success']) !!}
                        </div>
                    </div>
