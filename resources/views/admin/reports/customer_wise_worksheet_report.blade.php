...
$ImportTitle = \Carbon\Carbon::now()." Customer wise Work Report";
?>
                ...
                <div style="overflow: auto" class="box-body">
                    ...
                    <table id="table" style="display: none" class="table table-responsive table-bordered table-striped">
                        ...
                        @foreach(\App\Models\Customer::all() as $customer)
                            ...
                            $values = \App\Models\WorkSheet::where('customer_id',$customer->id)->whereBetween('date',[$from->format('Y-m-d'),$to->format('Y-m-d')])->get();
