...
$ImportTitle = \Carbon\Carbon::now()." Job Type wise Work Report";
?>
                ...
                <div style="overflow: auto" class="box-body">
                    ...
                    <table id="table" style="display: none" class="table table-responsive table-bordered table-striped">
                        ...
                        @foreach(\App\Models\JobType::all() as $jobType)
                            ...
                            $values = \App\Models\WorkSheet::where('job_type_id',$jobType->id)->whereBetween('date',[$from->format('Y-m-d'),$to->format('Y-m-d')])->get();
