...
<div class="box-body">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('number_of_hrs',null,['class'=>'form-control','id'=>'number_of_hrs','placeholder'=>'Number of Hrs']) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('budget_cost',null,['class'=>'form-control','id'=>'budget_cost','placeholder'=>'Budget Cost']) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('qouted_price',null,['class'=>'form-control','id'=>'qouted_price','placeholder'=>'Qouted Price']) !!}
        </div>
    </div>
</div>
<!-- /.box-body -->
