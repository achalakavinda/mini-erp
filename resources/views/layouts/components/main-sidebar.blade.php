    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @can(config('constant.Permission_Project'))
                <li class="treeview">
                    <a href="#"><i class="fa fa-train"></i> <span> Project Costing </span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                ...
                @can(config('constant.Permission_Company_Purchase_Requisition'))
                    <li class="treeview">
                        <a href="{{ url('ims/purchase-requisition') }}"><i class="fa fa-info"></i>
                            <span>Stock Refill Request</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
            ...
            @can(config('constant.Permission_Work_Sheet'))
                <li><a href="{{ url('/work-sheet/create') }}"><i class="fa fa-book"></i> <span>Work Report</span></a>
                </li>
